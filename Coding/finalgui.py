...
from tkinter_practice import generate_pdf_report
...
btn_export = tk.Button(root, text="Export Report to PDF", font=button_font, bg="blue", fg="white", height=2, width=20, command=generate_pdf_report)
...
btn_toggle_cache = tk.Button(root, text="Clear Cache", font=button_font, bg="blue", fg="white", height=2, width=20, command=toggle_cache_options)
btn_toggle_cache.pack(pady=5)

# Create Individual Clear Cache Buttons inside cache_frame (Two-column layout)
btn_clear_all = tk.Button(cache_frame, text="Clear All Cache", font=button_font, bg="red", fg="white", height=2, width=20, command=clear_all)
btn_clear_cache = tk.Button(cache_frame, text="Clear App Caches", font=button_font, bg="lightblue", fg="black", height=2, width=20, command=clear_all_caches)

btn_clear_recycle_bin = tk.Button(cache_frame, text="Clear Recycle Bin", font=button_font, bg="green", fg="white", height=2, width=20, command=clear_recycle_bin)
btn_clear_temp = tk.Button(cache_frame, text="Clear Temp Files", font=button_font, bg="purple", fg="white", height=2, width=20, command=clear_temp_files)

btn_clear_dns = tk.Button(cache_frame, text="Clear DNS Cache", font=button_font, bg="orange", fg="white", height=2, width=20, command=clear_dns_cache)
btn_clear_update_cache = tk.Button(cache_frame, text="Clear Windows Update Cache", font=button_font, bg="brown", fg="white", height=2, width=20, command=clear_windows_update_cache)
